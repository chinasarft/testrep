...
void TToolInitAdtsFixedHeader(TToolADTSFixheader *_pHeader) {
...
void TToolInitAdtsVariableHeader(TToolADTSVariableHeader *_pHeader, const int _nAacLenWithoutHeader) {
...
void TToolParseAdtsfixedHeader(const unsigned char *pData, TToolADTSFixheader *_pHeader) {
...
void TToolParseAdtsVariableHeader(const unsigned char *pData, TToolADTSVariableHeader *_pHeader) {
    unsigned long long adts = 0;
    adts  = pData[0]; adts <<= 8;
    adts |= pData[1]; adts <<= 8;
    adts |= pData[2]; adts <<= 8;
...
void TToolConvertAdtsHeader2Int64(const TToolADTSFixheader *_pFixedHeader, const TToolADTSVariableHeader *_pVarHeader, uint64_t *_pHeader) {
...
void TToolConvertAdtsHeader2Char(const TToolADTSFixheader *_pFixedHeader, const TToolADTSVariableHeader *_pVarHeader, unsigned char *pHeader) {
    uint64_t value = 0;
    TToolConvertAdtsHeader2Int64(_pFixedHeader, _pVarHeader, &value);
